   ...
   public void  parse (File file)
   {
      ...
      {            
         ...
         /*for (int k=0; k<Tokens.length; k++)
         {
            for (int p=0;p<80;p++)
            { 
               if (Tokens[k][p][0] != null) 
               {
                  //String t="Num" ,y =Tokens[LineNo][Nooftoken][0];
               
                  //System.out.println(y);
                  System.out.println(p+Tokens[k][p][0]+":"+ Tokens[k][p][1]); 
                  if (Tokens[k][p][0].equals("$"))
                  {System.out.println("Comparesion works!");  
                     System.out.println(Tokens[k][p][0]);
                  }
               }
            }
         }*/
